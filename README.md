...
- *ProtoGCD: Unified and Unbiased Prototype Learning for Generalized Category Discovery*  
  ...
  **TPAMI 2025**.
  [[paper]](https://ieeexplore.ieee.org/document/10948388)
  [[code]](https://github.com/mashijie1028/ProtoGCD)
...
ized category discover*    
    ...
    **NeurIPS 2025**    
    ...
    [[code]](https://github.com/Visual-AI/SEAL)
    [[Project page]](https://visual-ai.github.io/seal/)
  
- *Dissecting Generalized Category Discovery:
Multiplex Consensus under Self-Deconstruction* (ConGCD)   
    Luyao Tang, Kunze Huang, Chaoqi Chen, Yuxuan Yuan, Chenxin Li, Xiaotong Tu, Xinghao Ding, Yue Huang    
    **ICCV 2025**     
    [[paper]](https://arxiv.org/abs/2508.10731)
    [[code]](https://github.com/lytang63/ConGCD)

- *A Hidden Stumbling Block in Generalized Category Discovery: Distracted Attention*  (AFGCD)
...
- *Prior-constrained Association Learning for Fine-grained Generalized Category Discovery*         
  ...
  **AAAI 2025**.              
  [[paper]](https://arxiv.org/abs/2502.09501)
...
- *DebGCD: Debiased Learning with Distribution Guidance for Generalized Category Discovery*   
    Yuanpei Liu, Kai Han                     
    **ICLR 2025**.           
    [[paper]](https://arxiv.org/abs/2504.04804)
    [[code]](https://github.com/Visual-AI/DebGCD)
...
- *MOS: Modeling Object-Scene Associations in Generalized Category Discovery*         
    ...
    **CVPR 2025**                 
    [[paper]](https://openaccess.thecvf.com/content/CVPR2025/papers/Peng_MOS_Modeling_Object-Scene_Associations_in_Generalized_Category_Discovery_CVPR_2025_paper.pdf)
    [[code]](https://github.com/JethroPeng/MOS)
...
Generalized Category Discovery*          
    ...
    **CVPR 2025**          
    [[paper]](https://openaccess.thecvf.com/content/CVPR2025/papers/Wang_GET_Unlocking_the_Multi-modal_Potential_of_CLIP_for_Generalized_Category_CVPR_2025_paper.pdf)
    [[code]](https://github.com/enguangW/GET)

- *Less Attention is More:
Prompt Transformer for Generalized Category Discovery* (AptGCD)   
    Wei Zhang
, Baopeng Zhang, Zhu Teng
, Wenxin Luo
, Junnan Zou
, Jianping Fan    
    **CVPR 2025**    
    [[paper]](https://openaccess.thecvf.com/content/CVPR2025/papers/Zhang_Less_Attention_is_More_Prompt_Transformer_for_Generalized_Category_Discovery_CVPR_2025_paper.pdf)
    [[code]](https://github.com/wendy26zhang/AptGCD)
...
discovery robust to domain shift*             
    ...
    **ICLR 2025**          
    [[paper]](https://arxiv.org/abs/2408.04591)
    [[code]](https://github.com/Visual-AI/hilo/)
...
- *Generalized Class Discovery in Instance Segmentation*    
  ...
  **AAAI 2025** 
  [[paper]](https://arxiv.org/abs/2502.08149)
...
- *Novel Class Discovery for Ultra-Fine-Grained Visual Categorization* (RAPL)                               
    ...
    **CVPR 2024**                       
    [[paper]](https://arxiv.org/abs/2405.06283)
    [[code]](https://github.com/SSDUT-Caiyq/UFG-NCD)
...
- *Self-Cooperation Knowledge Distillation for Novel Class Discovery*  (SCKD)                       
    ...
    **ECCV 2024**                   
    [[paper]](https://arxiv.org/abs/2407.01930)
...
- *CiPR: An Efficient Framework with Cross-instance Positive Relations for Generalized Category Discovery*                                                          
    ...
    **TMLR 2024**            
    ...
    [[code]](https://github.com/haoosz/CiPR)

- *AMEND: Adaptive Margin and Expanded Neighborhood for Efficient
Generalized Category Discovery*                                       
...
- *Guided Cluster Aggregation: A Hierarchical Approach
to Generalized Category Discovery*                      
    ...
    **WACV 2024**                         
    ...
    [[code]](https://github.com/J-L-O/guided-cluster-aggregation)                 

- *SPTNet: An Efficient Alternative Framework for Generalized Category Discovery with Spatial Prompt Tuning*                 
    Hongjun Wang, Sagar Vaze, Kai Han                   
    **ICLR 2024**                         
    [[paper]](https://arxiv.org/abs/2403.13684)
...
- *Solving the Catastrophic Forgetting Problem in Generalized Category Discovery* (LegoGCD)                                             
    ...
    **CVPR 2024**               
    [[paper]](https://openaccess.thecvf.com/content/CVPR2024/papers/Cao_Solving_the_Catastrophic_Forgetting_Problem_in_Generalized_Category_Discovery_CVPR_2024_paper.pdf)
    [[code]](https://github.com/Cliffia123/LegoGCD)
...
- *Targeted Representation Alignment for Open-World Semi-Supervised Learning* (TRAILER)           
    ...
    **CVPR 2024**              
    ...
    [[code]](https://github.com/Justherozen/TRAILER)                    
...
- *Textual Knowledge Matters: Cross-Modality Co-Teaching for Generalized Visual Class Discovery* (TextGCD)                               
    ...
    **ECCV 2024**      
    ...
    [[code]](https://github.com/HaiyangZheng/TextGCD)
...
- *Learning to Distinguish Samples for Generalized Category Discovery*                    
    ...
    **ECCV 2024**             
    [[paper]](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08177.pdf)

- *SelEx: Self-Expertise in Fine-Grained Generalized Category Discovery*               
    Sarah Rastegar, Mohammadreza Salehi, Yuki M. Asano, Hazel Doughty, Cees G. M. Snoek         
    **ECCV 2024**              
    [[paper]](https://arxiv.org/abs/2408.14371)
...
-  *Bridging the gap: Learning pace synchronization for open-world semi-supervised learning*           
    ...
    **IJCAI 2024**                      
    [[paper]](https://www.ijcai.org/proceedings/2024/0593.pdf)    [[code]](https://github.com/yebo0216best/LPS-main)              
...
- *OwMatch: Conditional Self-Labeling with Consistency for Open-World Semi-Supervised Learning*                 
    ...
    **NeurIPS 2024**            
    [[paper]](https://arxiv.org/abs/2411.01833)
    [[code]](https://github.com/niusj03/OwMatch)
...
- *Flipped Classroom: Aligning Teacher Attention with Student in Generalized Category Discovery*                
    ...
    **NeurIPS 2024**        
    [[paper]](https://arxiv.org/abs/2409.19659)             
...
- *Contextuality Helps Representation Learning for Generalized Category Discovery*                  
    ...
    **ICIP 2024**        
    [[paper]](https://arxiv.org/abs/2407.19752)
...
- *Adaptive Discovering and Merging for Incremental Novel Class Discovery*              
    ...
    **AAAI 2024**           
    [[paper]](https://arxiv.org/abs/2403.03382)
...
- *PromptCCD: Learning Gaussian Mixture Prompt Pool for Continual Category Discovery*               
    ...
    **ECCV 2024**               
    ...
    [[Project Page]](https://visual-ai.github.io/promptccd/)
...
- *Category Adaptation Meets Projected Distillation in Generalized Continual Category Discovery*  (CAMP)              
    ...
    **ECCV 2024**           
    ...
    [[code]](https://github.com/grypesc/CAMP)               
...
- *What's in a Name? Beyond Class Indices for Image Recognition*            
    ...
    **CVPR Workshop 2024**                  
    ...
    [[code]](https://github.com/Visual-AI/SCD)

- *Semantic-Guided Novel Category Discovery*            
    Weishuai Wang, Ting Lei, Qingchao Chen, Yang Liu
    **AAAI 2024**                                   
    [[paper]](https://ojs.aaai.org/index.php/AAAI/article/view/28371)

- *Democratizing Fine-grained Visual Recognition with Large Language Models*                
    Mingxuan Liu, Subhankar Roy, Wenjing Li, Zhun Zhong, Nicu Sebe, Elisa Ricci             
    **ICLR 2024**               
    [[paper]](https://arxiv.org/abs/2401.13837)
...
- *PANDAS: Prototype-based Novel Class Discovery and Detection*             
    ...
    **CoLLAs 2024**                            
    [[paper]](https://arxiv.org/abs/2402.17420)

- *Dual-level Adaptive Self-Labeling for Novel Class Discovery in Point Cloud Segmentation*             
    Ruijie Xu, Chuyu Zhang, Hui Ren, Xuming He          
    **ECCV 2024**               
    [[paper]](https://arxiv.org/abs/2407.12489)

- *A Unified Knowledge Transfer Network for Generalized Category Discovery*         
    Wenkai Shi, Wenbin An, Feng Tian, Yan Chen, Yaqiang Wu, Qianying Wang, Ping Chen
    **AAAI 2024**               
    [[paper]](https://ojs.aaai.org/index.php/AAAI/article/view/29862)
    [[code]](https://github.com/yibai-shi/KTN)

- *Novel class discovery in chest X-rays via paired images and text*            
    Jiaying Zhou, Yang Liu, Qingchao Chen           
    **AAAI 2024**               
    [[paper]](https://dl.acm.org/doi/10.1609/aaai.v38i7.28598)
